...
export function Footer() {
  ...
  return (
    <footer className="bg-[#003B2D]">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-[30px] pt-16 pb-8 flex flex-col items-center">
        {/* Logo */}
        ...
        <div className="w-full max-w-2xl mx-auto mb-10">
          <h4 className="text-white font-semibold text-lg text-center mb-4">
