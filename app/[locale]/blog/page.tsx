        ...
        <div className="max-w-[1280px] mx-auto px-4 sm:px-[30px]">
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {posts.map((post, i) => (
              <article
                key={i}
                className="group bg-white rounded-[20px] border border-[#EAF0EF] overflow-hidden hover:border-[#0D883C]/40 hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
              >
